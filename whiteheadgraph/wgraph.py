...
def simplify_wordlist(F, wl1,wl2=[],withmap=False, verbose=False): 
    """
    Find cyclically reduced roots of words in wl1 that are needed to generate distinct conjugacy classes of maximal cyclic subgroups not already generated by roots of elements in wl2.  The resulting words are lex minimal among such words (including their inverses).
    """
